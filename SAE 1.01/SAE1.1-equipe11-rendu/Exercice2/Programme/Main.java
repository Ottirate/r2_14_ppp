...
//Import des classes pour décomposer des phrases
import iut.algo.Decomposeur;
import java.util.StringTokenizer; //Utilisé pour déterminer le nombre de prof
...
public class Main
{
    public static void main(String[] args) 
    {
        ...
        try
        {
            ...
            //Décompose et compte le nombre de jurry
            ...
            //Décompose les profs pour les donner dans la classe Jury
            scanner = new Scanner (new FileInputStream(FICHE_JURY));
            scanner.nextLine();
            ...
            for (int cpt1 = 0; cpt1 < jury.length; cpt1++)
            {
                ...
                //Transformation des heure en décimal
            ...
            //Affichage
            String date = "";
            for (cpt = 0; cpt < jury.length; cpt++)
            {
                if (!jury[cpt].getDate().equals(date))
                {
                    System.out.println("---------------------------------\n"+ 
                                        jury[cpt].getDate()              + 
                                     "\n---------------------------------\n");
                    date = jury[cpt].getDate();
                }

                System.out.println(jury[cpt]);
            }
        ...
        //fichier n'existe pas, pour éviter de nombreuses
        //erreur
