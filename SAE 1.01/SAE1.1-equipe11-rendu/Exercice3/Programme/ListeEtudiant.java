//importations pour écrire dans un fichier
...
public class ListeEtudiant
{
    ...
    {
		/*Nom des fichiers*/
		final String      PAGE_LISTE_ETUDIANTS  = "../Web/Page1/listeEtudiant.html";       //Fichier html
        ...
        try
        {
    		...
    		pw.println ( "		<meta name=\"description\" content=\"Liste des étudiants\"> " );
            ...
            pw.println ( "  <body>" );
            pw.println ( "      <header>" );
            pw.println ( "          <h1>Liste des étudiants</h1>");
            pw.println ( "      </header>" );
			...
			pw.println ( "      					<th>Prénom</th>" );
			pw.println ( "      					<th>Groupe</th>" );
			pw.println ( "      					<th>Num équipe</th>" );
			pw.println ( "      				</tr>" );
			pw.println ( "      			</thead>" );
			pw.println ( "      			<tbody>" );
			...
			{
				/*Coloration alternée des cases du tableau*/
				if( cpt%2 == 1 )
				{
					couleur = "gris";
				}
